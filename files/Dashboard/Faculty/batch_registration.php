...
<html>
<head>
    <title>TERM - BATCH REGISTERATION</title>
        ...
        <div class="col-lg-12 col-md-6 col-sm-12" style="border-top:1px solid grey;"><br><br>
            ...
            <form method="POST" action="" id="gbhlform">
                ...
                <table class="table table-striped table-bordered table-hover table-responsive table-scrollable-borderless" style="width: 900px;" align="center">
                    <tr>
                        <td colspan="6" style="text-align: center;"><h5><strong>Batch Registration</strong></h5></td>
                    </tr>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(document).on("click","#activate",function(e){
            ...
            if($("#academic_year").val() == 0){
                $('#response').html('<div align="center"><span class="alert alert-danger">Batch registration unsuccessful, please select an academic year .</span></div><br>');
                $("#reponse").fadeOut(1500);
                $("#wait").css("display","none");
                ...
                $.ajax({
                    type: "POST",
                    url: "post_batch_registration.php",
                    data: form,
                    success: function (k) {
                        console.log(k);
                        if (k == 'success') {
                            $('#response').html('<div align="center"><span class="alert alert-success">Batch registration successful.</span></div><br>');
                            ...
                            $('#response').html('<div align="center"><span class="alert alert-danger"><i class="icon icon-remove-sign"></i>Sorry this batch registration has been done already.</span></div><br>');
                            $("#response").fadeOut(15000);
                            $("#wait").css("display", "none");
                            $("#activate").removeAttr("disabled", "disabled");
                            $('html, body').animate({scrollTop: 0}, 800);
                            ...
                            $('#response').html('<div align="center"><span class="alert alert-danger"><i class="icon icon-remove-sign"></i>Sorry this batch registration failed Please make sure courses have been assigned to this batch.</span></div><br>');
                            $("#response").fadeOut(15000);
                            $("#wait").css("display", "none");
                            $("#activate").removeAttr("disabled", "disabled");
                            $('html, body').animate({scrollTop: 0}, 800);
